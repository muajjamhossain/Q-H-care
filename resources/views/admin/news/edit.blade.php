...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/news/update')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text"  id="birththday" autocomplete="off"  class="form-control form_control" name="date" value="{{$data->news_date}}">
                      @if ($errors->has('date'))
                          <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('pic') ? ' has-error' : '' }}">
                    ...
                    <div>
                      <img height="104" src="{{asset('uploads/news/'.$data->news_image)}}" alt="">
                    </div>
                </div>
              </div>
