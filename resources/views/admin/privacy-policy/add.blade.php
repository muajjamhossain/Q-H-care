...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/privacy/policy/submit')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('details') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <textarea name="details" class="form-control" rows="10" cols="80">{{old('details')}}</textarea>
