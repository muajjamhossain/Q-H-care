      ...
      <form method="post" action="{{url('dashboard/manage/contact/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fa fa-gg-circle"></i> Contact Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/manage/social/media')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fa fa-th label-icon"></i> Social Media</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-md-6 mb-2">
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-phone-square fa-lg"></i></span></div>
                ...
                <div class="col-md-6 mb-2">
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-home fa-lg"></i></span></div>
