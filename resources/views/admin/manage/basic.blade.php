      ...
      <form method="post" action="{{url('dashboard/manage/basic/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fa fa-gg-circle"></i> Basic Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/manage/contact')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fa fa-th label-icon"></i> Contact Information</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
              ...
              <div class="form-group row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label">Contact Image:</label>
                  <div class="col-sm-4">
                    <div class="input-group">
                        <span class="input-group-btn">
                            <span class="btn btn-default btn-file btnu_browse">
                                Browse… <input type="file" name="contactpik" id="imgInpContact">
                            </span>
                        </span>
                        <input type="text" class="form-control" readonly>
                    </div>
                    <img id="img-upload-contact"/>
                  </div>
                  <div class="col-md-2">
                    @if($basic->basic_contactpik!='')
                      <img class="img-thumbnail img100" src="{{asset('uploads/basic/'.$basic->basic_contactpik)}}"/>
                    @else
                      <img class="img-thumbnail img100" src="{{asset('uploads/avatar/noimg.jpg')}}"/>
                    @endif
                  </div>
